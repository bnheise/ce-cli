...
use super::{configuration, export_task_params::ExportTaskParams, Error};
...
pub fn post_export_task<T>(
    configuration: &configuration::Configuration,
    class_name: &str,
    content_type: &str,
    options: ExportTaskParams<T>,
    ...
    T: Display + Default,
{
    ...
    if let Some(ref local_var_str) = options.field_names {
        local_var_req_builder =
