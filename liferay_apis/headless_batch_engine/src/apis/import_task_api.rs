...
use super::{configuration, import_task_params::ImportTaskParams, Error};
...
pub fn delete_import_task1<T>(
    configuration: &configuration::Configuration,
    class_name: &str,
    options: &ImportTaskParams<T>,
